...
# Database field lists for NCAA Basketball
Date = []
Opponent = []
Result = []
Tm = []
...
def ncaabdb(team, year=current_year):
    ...
    try:
        ...
        stats_per_game = 28  # Adjust based on actual table structure
...
def get_team_stats(team, year):
    """
    Main function to get NCAA Basketball team stats
    """
    try:
...
# Common NCAA Basketball teams
NCAAB_COMMON_TEAMS = [
    "alabama", "arizona", "arkansas", "auburn", "baylor",
    "duke", "florida", "florida-state", "gonzaga", "illinois",
    "indiana", "kansas", "kentucky", "louisville", "marquette",
    "michigan", "michigan-state", "north-carolina", "ohio-state",
    "purdue", "tennessee", "texas", "texas-am", "ucla", "villanova",
